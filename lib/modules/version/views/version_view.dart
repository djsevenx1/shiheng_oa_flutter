    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildInfoRow('版本', 'v2.5.7 (Build 257)'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12.h),
          _buildLogItem('v2.4.6', '2026-07-21', [
            '优化日期选择器UI：主题色+尺寸约束',
          ]),
          SizedBox(height: 12.h),
          _buildLogItem('v2.4.5', '2026-07-21', [
            '修复明细编辑弹窗需求日期显示异常',
            '日期字段改用readOnly TextFormField+onTap弹日期选择器',
          ]),
          SizedBox(height: 12.h),
          _buildLogItem('v2.4.4', '2026-07-21', [
            '详情页明细区域添加编辑和新增功能',
            '每条明细紫色标题栏+编辑按钮+删除按钮',
            '新增明细按钮+编辑弹窗',
          ]),
